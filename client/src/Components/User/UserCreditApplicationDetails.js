                ...
                <Col md={8} className="text-center">
                  <div className="UCADcirclecontainer">
                    ...
                    {user?.approvalstatus === "Approved" ? (
                      <>
                        ...
                        <div className="UCADcirclecontainer-3">
                          <div className="circlecontainerdiv">
                            ...
                            <span className="UCAD-progress-text">Manager Approved</span>
                          </div>
                        </div>
                      ...
                      <>
                        <div className="UCAD-profildetaildline rejected" />
                        <div className="UCADcirclecontainer-3">
                          <div className="circlecontainerdiv">
                            <div className="UCADcircle rejected">
                              {/* You can use a red cross icon instead of checkmark */}
                              <img src={checkmark} alt="rejected" />
                            </div>
                            <span className="UCAD-progress-text">Manager Rejected</span>
                          </div>
                        </div>
                        ...
                        <div className="UCADcirclecontainer-4">
                          <div className="circlecontainerdiv">
                            ...
                            <span className="UCAD-progress-text">Card Rejected</span>
                          </div>
                        </div>
                      </>
                    ) : (
